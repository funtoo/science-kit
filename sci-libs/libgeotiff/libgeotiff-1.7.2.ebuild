...
SRC_URI="https://github.com/OSGeo/libgeotiff/tarball/81f36b3cba95703a46bb0f9aab13eb1c7884c8f9 -> libgeotiff-1.7.2-81f36b3.tar.gz"
...
post_src_unpack() {
	if [ ! -d "${WORKDIR}/${S}" ]; then
		mv "${WORKDIR}"/OSGeo-libgeotiff-81f36b3/libgeotiff "${S}" || die
	fi
}
